...
#
    ...
    if 1:
        ...
        # http://monologue.hatenadiary.jp/entry/2015/02/19/005606
        # 追加 kurosawa.
        keymap_global[ "U0-A" ] = "C-A"                # 全て選択
        keymap_global[ "U0-F" ] = "C-F"                # 検索
        keymap_global[ "U0-H" ] = "C-H"                # 置換
        keymap_global[ "U0-C" ] = "C-C"                # コピー
        keymap_global[ "U0-V" ] = "C-V"                # ペースト
        keymap_global[ "U0-D" ] = "LWin-D"             # デスクトップ表示
        keymap_global[ "U0-S" ] = "C-S"                # 保存
        keymap_global[ "U0-Z" ] = "C-Z"                # アンドゥ
        keymap_global[ "U0-S-Z" ] = "C-Y"              # リドゥ
        #
